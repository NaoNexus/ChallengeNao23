...
% --TODO--
% - Review all document
% - Fit the text into 7 pages
% - Add links between sections (eg. when writing of the server in NAO sections)
% - Check impagination and vspaces
% - Bibliography, authors and team members
...
\noindent
\textit{Write an email at: }\email{socialnaonexus@gmail.com}
